...
const HomeAbout = () => {
  return (
    <section className="about__section" style={{ marginTop: "60px" }}>
      <Container>
        <Row>
          <Col lg="6" md="6">
            <div className="about__section-content">
              <h4 className="section__subtitle">About Us</h4>
              <h2 className="section__title">Welcome to Kashi Cycle Company</h2>
          ...
          <Col lg="6" md="6">
            <div className="about__img">
              <img
                src={
                  "https://www.freeiconspng.com/uploads/cycle-bike-bicycle-png-image-7.png"
                }
                alt="about image"
                className="w-100"
              />
